...
<body>
  ...
  <main class="container">
    <div class="d-flex justify-content-end mb-3">
        <a href="adddorm.php" class="btn btn-success add-dorm">+ Add Dorm</a>
    </div>
            ...
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <div class="btn-container">
                        <a href="adddorm2.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Update</a>
                        <a href="deletedorm.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this book?');">Delete</a>
